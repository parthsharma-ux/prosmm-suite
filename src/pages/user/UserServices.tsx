                ...
                <div className="flex items-start gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {getCategoryName(service.category_id) && (
                      <p className="text-[11px] text-muted-foreground mt-0.5">{getCategoryName(service.category_id)}</p>
                    )}
                  </div>
                </div>
                {service.description && (
                  <p className="text-xs text-muted-foreground leading-relaxed whitespace-pre-wrap break-words" style={{ overflowWrap: "anywhere" }}>
                    {service.description}
                  </p>
                )}
            ...
            {service && (
              <div className="flex items-center justify-between rounded-lg bg-primary/5 border border-primary/10 px-4 py-2.5 text-xs animate-in fade-in duration-200">
                <span className="text-muted-foreground font-medium flex items-center gap-1.5">
                  <Zap className="h-3 w-3 text-primary" /> Rate per 1K
                </span>
